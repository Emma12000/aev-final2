...
const DB = {
  cats: [
    ...
    { id:"partenariat",   name:"Partenariats",              icon:"ti-handshake",          color:"#0F766E", bg:"#F0FDFA", conf:"interne",       tags:["ONG","Accord","Collaboration"] },
    { id:"communication", name:"Communication",             icon:"ti-megaphone",          color:"#BE185D", bg:"#FDF2F8", conf:"public",        tags:["Plaquette","Presse","Visuel"] },

...
function mapActivity(a) {
  const actionMap = {
    LOGIN: "CONNEXION", LOGOUT: "DÉCONNEXION", UPLOAD: "DÉPÔT",
    DOWNLOAD: "TÉLÉCHARGEMENT", UPDATE: "MODIFICATION", VIEW: "ACCÈS",
    CREATE: "CRÉATION", DELETE: "SUPPRESSION", APPROVE: "APPROBATION", REJECT: "REJET",
  };
  return {
    id:           a.id,
